...
import { bootPending, markBooted } from "./bootState";

const BOOT_MS_TOTAL = 1500;

// One-shot boot intro (per browser session): lime slit grows over a
// forest-deep screen while a pixel counter runs up, then the two panels
// part to reveal the page. Skipped entirely for reduced motion.
