...
const FAQ: Item[] = [
  ...
  { q: "Mi a különbség köztetek és egy ChatGPT bevezetés között?", a: "A ChatGPT egy eszköz. Mi rendszereket építünk, amik konkrét üzleti folyamatokat futtatnak — számlákat dolgoznak fel, ügyfeleket szolgálnak ki, riportokat készítenek. Egy ChatGPT-fiók 20 USD/hó. Egy Zentopia-rendszer 0-tól dolgozik, integrálva a többi rendszereddel." },
